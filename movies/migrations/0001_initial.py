    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.CharField(choices=[('G', 'G'), ('PG', 'Pg'), ('PG_13', 'Pg 13'), ('R', 'R'), ('NC_17', 'Nc 17')], default='G', max_length=20)),
        ...
        migrations.AddField(
            model_name='movie',
            name='user_buy',
            field=models.ManyToManyField(related_name='movies_bought', through='movies.MovieOrder', to=settings.AUTH_USER_MODEL),
        ),
    ]
