...
class MovieOrder(models.Model):
    user_order = models.ForeignKey("users.User", on_delete= models.CASCADE, related_name="movies_order")
    movie_order= models.ForeignKey("movies.Movie", on_delete= models.CASCADE, related_name="owner")
